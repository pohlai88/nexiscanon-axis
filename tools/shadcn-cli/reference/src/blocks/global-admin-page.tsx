...
export function GlobalAdminPage({
  ...
  const [selectedUser, setSelectedUser] = React.useState<UserAccount | null>(
    null,
  );
  ...
  return (
    <div className={cn('flex h-full flex-col', className)}>
      {/* Header */}
      <div className="border-b bg-gradient-to-r from-blue-600 to-purple-600 p-6 text-white">
      ...
      <div className="flex-1 overflow-hidden">
        ...
        >
          ...
          <ScrollArea className="h-full">
                ...
                <Card>
                  ...
                  <CardContent className="space-y-3">
                    ...
                    <StatusItem
                      ...
                      label="Security"
                      value={
                        metrics.security.failedLogins > 10 ? 'Alert' : 'Normal'
                      }
            ...
            <TabsContent value="security" className="space-y-6 p-6">
              <div className="grid grid-cols-3 gap-4">
                ...
                <Card className="border-orange-200 dark:border-orange-900">
                  <CardContent className="p-4 text-center">
                    <ShieldAlert className="mx-auto mb-2 h-8 w-8 text-orange-600" />
                    <p className="text-2xl font-bold">
                  ...
                  <CardContent className="space-y-4">
                    {categorySettings.map((setting) => (
                      <SettingItem
                        ...
                        setting={setting}
                        onUpdate={(value) =>
                          onUpdateSetting?.(setting.id, value)
                        }
                      />
                    ))}
                  </CardContent>
            ...
            {/* Performance Tab */}
            <TabsContent value="performance" className="space-y-6 p-6">
              <div className="grid grid-cols-3 gap-4">
                <Card>
                  <CardHeader>
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="bg-muted h-2 w-full overflow-hidden rounded-full">
                        <div
                          ...
                          style={{
                            width: `${metrics.performance.memoryUsage}%`,
                          }}
                        />
                      </div>
                    </div>
...
function StatCard({
  ...
  return (
    <div
      className={cn(
        'rounded-lg bg-white/10 p-4 backdrop-blur-sm',
    ...
    >
      ...
      <p className="mt-1 text-xs text-blue-200">{subValue}</p>
    </div>
  );
}
  ...
  return (
    <div className="flex items-center justify-between">
      ...
      <div className="flex items-center gap-2">
        ...
        {setting.locked && <Lock className="text-muted-foreground h-4 w-4" />}
      </div>
    </div>
  );
}
