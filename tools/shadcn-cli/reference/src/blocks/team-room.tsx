...
export function TeamRoom({
  ...
  const myTasks = tasks.filter(
    (t) => t.assignee?.id === currentUserId && t.status !== 'done',
  );
  ...
  return (
    <div className={cn('flex h-screen', className)}>
      ...
      <div className="bg-muted/20 flex w-16 flex-col items-center gap-3 border-r py-4">
      ...
      <div className="flex flex-1 flex-col">
          ...
          <div className="flex items-center justify-between">
            <div>
              <div className="flex items-center gap-2">
                ...
                <Badge
                  variant={
                    roomType === 'incident' ? 'destructive' : 'secondary'
                  }
                >
                  {roomType}
                </Badge>
        ...
        >
          <div className="border-b px-4">
            <TabsList>
              <TabsTrigger value="feed">
                ...
                Feed
                {messages.filter((m) => m.mentions?.includes(currentUserId))
                  .length > 0 && (
                  <Badge
                    variant="destructive"
          ...
          <div className="flex-1 overflow-hidden">
            ...
            {/* Approvals Tab */}
            <TabsContent value="approvals" className="m-0 h-full p-4">
            ...
            {/* Meetings Tab */}
            <TabsContent value="meetings" className="m-0 h-full p-4">
              <ScrollArea className="h-full">
                <div className="max-w-4xl space-y-4">
                  <div className="mb-4 flex items-center justify-between">
            ...
            {/* Jobs Tab */}
            <TabsContent value="jobs" className="m-0 h-full p-4">
              <ScrollArea className="h-full">
                <div className="max-w-4xl space-y-4">
                  <div className="mb-4 flex items-center justify-between">
      ...
      <CardContent className="space-y-4">
        ...
        {isMyApproval && (
          <div className="flex gap-2 pt-2">
            <Button className="flex-1" onClick={() => onApprove?.(approval.id)}>
              <CheckCircle className="mr-2 h-4 w-4" />
              Approve
            </Button>
            <Button
    ...
    <Card>
      ...
      <CardContent className="space-y-4">
        {meeting.decisions && meeting.decisions.length > 0 && (
          <div>
            <h5 className="mb-2 text-sm font-semibold">Decisions</h5>
        ...
        {meeting.actionItems && meeting.actionItems.length > 0 && (
          <div>
            <h5 className="mb-2 text-sm font-semibold">Action Items</h5>
            <ul className="space-y-1">
              {meeting.actionItems.map((item) => (
                <li key={item.id} className="flex items-start gap-2 text-sm">
                  <input type="checkbox" checked={item.done} className="mt-1" />
        ...
        <div className="flex -space-x-2">
          {meeting.participants.map((p) => (
            <Avatar key={p.id} className="border-background h-6 w-6 border-2">
      ...
      <CardContent className="p-4">
        <div className="flex items-start justify-between">
          <div className="flex-1">
            ...
            <p className="text-muted-foreground mb-2 text-xs">{job.type}</p>
