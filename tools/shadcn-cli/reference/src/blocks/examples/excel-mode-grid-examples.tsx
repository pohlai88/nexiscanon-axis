...
import { ExcelModeGrid, type GridColumn, type GridRow, type CellChange } from '../excel-mode-grid';
import { NavbarOverlay } from '../navbar-overlay';
import { CRUDSPToolbar, ERPModulePresets } from '../crudsp-toolbar';
...
export function InvoiceBulkStatusUpdate() {
  ...
  const [invoices, _setInvoices] = React.useState<Invoice[]>([
    {
      id: '1',
...
export function EmployeeBulkUpdate() {
  ...
  const [employees, _setEmployees] = React.useState<Employee[]>([
    {
      id: '1',
      emp_id: 'EMP-001',
      name: 'John Doe',
