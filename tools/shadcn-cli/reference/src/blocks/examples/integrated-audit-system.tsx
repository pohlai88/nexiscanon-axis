...
export function IntegratedAuditSystem() {
  ...
  const [auditEntries, _setAuditEntries] = React.useState<AuditEntry[]>([
    {
      id: '1',
  ...
  const MainContent = () => (
    <div className="space-y-6 p-6">
      <div>
        <h1 className="mb-2 text-3xl font-bold">Document Management System</h1>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
        ...
        <div className="bg-card rounded-lg border p-6">
          <h3 className="mb-2 font-semibold">Marketing Strategy 2024</h3>
          <p className="text-muted-foreground text-sm">
    ...
    <div className="flex h-screen flex-col">
      ...
      <div className="flex-1 overflow-hidden pt-16">
        <DoubleScreenLayout
          leftContent={
            <div className="p-6">
              <h2 className="mb-4 text-xl font-bold">Version 1.0 (Original)</h2>
          ...
          rightContent={
            <div className="p-6">
              <h2 className="mb-4 text-xl font-bold">Version 2.0 (Current)</h2>
              <div className="prose max-w-none">
                {/* Document content */}
