...
<CRUDSPToolbar actions={ERPModulePresets.salesOrders(handlers)} />;
```
...
```tsx
<CRUDSPToolbar actions={ERPModulePresets.inventory(handlers)} />
```
...
```tsx
<CRUDSPToolbar actions={ERPModulePresets.crm(handlers)} />
```
...
```tsx
<CRUDSPToolbar actions={ERPModulePresets.hr(handlers)} />
```
...
```tsx
<CRUDSPToolbar actions={ERPModulePresets.finance(handlers)} />
```
...
<CRUDSPToolbar actions={actions} permissions={permissions} />;
```
