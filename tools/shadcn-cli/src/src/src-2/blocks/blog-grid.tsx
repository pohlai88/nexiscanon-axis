      ...
      <div className="grid md:grid-cols-2">
        ...
        <div className="flex flex-col justify-between p-8">
          <div>
            ...
            <h2 className="group-hover:text-primary mb-4 text-2xl font-bold tracking-tight transition-colors">
              {post.title}
            </h2>
    ...
    <Card className="group flex flex-col overflow-hidden transition-all hover:shadow-lg">
      ...
      <div className="relative h-48 overflow-hidden">
        <img
          ...
          className="h-full w-full object-cover transition-transform duration-500 group-hover:scale-110"
        />
        <Badge className="bg-primary/90 absolute top-4 left-4 backdrop-blur-sm">
          {post.category}
        </Badge>
      </div>
      ...
      <div className="flex flex-1 flex-col p-6">
        ...
        <h3 className="group-hover:text-primary mb-3 text-lg font-semibold tracking-tight transition-colors">
          {post.title}
        </h3>
