                ...
                {showIndicator && (
                  <span
                    className={cn(
                      ...
                      isRecent ? 'animate-pulse bg-orange-500' : 'bg-blue-500',
                      indicatorPosition === 'top-right' && '-top-1 -right-1',
                      indicatorPosition === 'top-left' && '-top-1 -left-1',
        ...
        {changes.map((change, index) => (
          <div key={change.id} className="relative">
            ...
            {index < changes.length - 1 && (
              <div className="bg-border absolute top-8 bottom-0 left-[13px] w-px" />
            )}
