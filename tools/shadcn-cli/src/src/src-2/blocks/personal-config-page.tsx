...
export function PersonalConfigPage({
  ...
  return (
    <div className={cn('flex h-full flex-col', className)}>
      ...
      {/* Main Content */}
      <div className="container mx-auto mt-6 max-w-6xl flex-1 overflow-hidden px-6">
        <div className="grid h-full grid-cols-3 gap-6">
          ...
          <div className="col-span-2 space-y-6">
            <Card className="h-full">
              ...
              <CardContent>
                <div className="bg-muted/20 relative h-[500px] rounded-lg border-2 border-dashed p-4">
                  {notes.length === 0 ? (
                    <div className="flex h-full items-center justify-center text-center">
                      <div>
                        <StickyNote className="text-muted-foreground mx-auto mb-3 h-12 w-12" />
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Button
                    variant={
                      preferences.notifications.push ? 'default' : 'outline'
                    }
                    size="sm"
                    onClick={() =>
                      onUpdatePreferences?.({
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Button
                    variant={
                      preferences.notifications.sound ? 'default' : 'outline'
                    }
                    size="sm"
                    onClick={() =>
                      onUpdatePreferences?.({
...
function StickyNoteComponent({
  ...
  return (
    <div
      className="absolute h-48 w-48 cursor-move rounded-lg p-4 shadow-lg"
      style={{
...
function AchievementBadge({
  ...
  return (
    <div className="flex items-center gap-3 rounded-lg border bg-gradient-to-r from-yellow-50 to-orange-50 p-3 dark:from-yellow-950 dark:to-orange-950">
