...
export function PolicyAwareButton({
  ...
  const lockIcon = showLockIcon ? <Lock className="mr-2 h-4 w-4" /> : null;
          ...
          {showTooltip && (
            <TooltipContent side={tooltipSide}>
              <div className="max-w-xs">
                <p className="mb-1 text-sm font-semibold">{policy.name}</p>
      ...
      <div className="space-y-4 py-4">
        ...
        <div className={cn('rounded-lg border p-4', getSeverityColor())}>
          <div className="flex items-start gap-2">
            ...
            <div>
              <p className="mb-1 text-sm font-semibold">Why is this locked?</p>
              ...
              <div>
                ...
                <div className="text-muted-foreground space-y-1 text-sm">
                  {policy.valueLimit.current !== undefined && (
                    <p>
                      Current: ${policy.valueLimit.current.toLocaleString()}
                    </p>
                  )}
          ...
          {policy.dependency && (
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-muted-foreground text-sm">
                  {policy.dependency.field} must be "
                  {String(policy.dependency.requiredValue)}"
                </p>
                <p className="text-muted-foreground text-sm">
        ...
        {policy.howToUnlock && (
          <div className="rounded-lg border bg-green-50 p-4 dark:bg-green-950">
            <div className="flex items-start gap-2">
              <Key className="mt-0.5 h-5 w-5 flex-shrink-0 text-green-600" />
              <div>
...
export function PolicyAwareSection({
  ...
  return (
    <div className={cn('relative', className)}>
      <div className="bg-background/60 absolute inset-0 z-10 flex items-center justify-center rounded-lg backdrop-blur-[2px]">
        <Dialog>
          <DialogTrigger asChild>
...
export const COMMON_POLICIES = {
  cfoApproval: (amount: number): PolicyRule => ({
    ...
    howToUnlock:
      'Request approval from the CFO. They will be notified immediately.',
    requiredApproval: {
      from: 'CFO',
      department: 'Finance',
    },
  ...
  businessHours: (): PolicyRule => ({
    ...
    reason:
      'For compliance and security, payroll can only be processed Mon-Fri 9AM-5PM',
    howToUnlock:
      'Wait until next business day or contact IT for emergency override',
    timeConstraint: {
