      ...
      >
        <div className="flex flex-col" style={{ maxHeight }}>
          ...
          {replyingTo && replyToMessage && (
            <div className="bg-muted/20 flex items-start gap-2 border-t px-3 py-2">
              <Reply className="text-muted-foreground mt-0.5 h-4 w-4" />
...
function ChatMessageItem({
  ...
  return (
    <div
      className={cn('group flex gap-2', isCurrentUser && 'flex-row-reverse')}
    ...
    >
      ...
      >
        ...
        {/* Reply Context */}
        {replyToMessage && (
          <div className="border-primary bg-muted/30 mb-2 rounded-md border-l-2 p-2 text-xs">
