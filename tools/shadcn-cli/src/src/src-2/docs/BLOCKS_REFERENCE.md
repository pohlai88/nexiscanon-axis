  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 gap-6">
        <SmartTaskList tasks={projectTasks} groupBy="status" showStats />
        <ActivityFeed activities={recentActivities} groupByDate />
      </div>
    </div>
  );
}
    ...
    <MultiStepWizard
      steps={[
        ...
        },
        {
          ...
          title: 'Upload Photo',
          component: (
            <FileUploadZone files={files} onFilesAdded={handleUpload} />
          ),
          optional: true,
        },
        {
