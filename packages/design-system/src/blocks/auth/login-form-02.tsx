      ...
      <FieldGroup>
        ...
        {(onGitHubLogin || onGoogleLogin) && (
          <>
            ...
            <Field>
              {onGitHubLogin && (
                <Button variant="outline" type="button" onClick={onGitHubLogin} className="w-full">
              ...
              {onGoogleLogin && (
                <Button variant="outline" type="button" onClick={onGoogleLogin} className="w-full mt-2">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="mr-2 h-4 w-4">
                    <path
