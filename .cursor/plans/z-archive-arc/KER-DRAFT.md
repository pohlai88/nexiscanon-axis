...
* **K-M4 Cryptographic Keymaster (KMS / Signing Primitive)** ✅ *(added)*
...
* **K-M5 Async Job Scheduler (Heartbeat)** ✅ *(added)*
...
* **K-M6 Traffic Governor & Idempotency (Bouncer)** ✅ *(added)*
  Per-tenant rate limiting + quotas + Idempotency-Key replay cache

### K-O) Observability Plane

* **K-M7 Telemetry Propagation (Tracer)** ✅ *(added)*
