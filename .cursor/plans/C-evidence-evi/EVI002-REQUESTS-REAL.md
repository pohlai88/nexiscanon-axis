...
```json
{
  "event": "domain.wiring",
  "wired": "drizzle",
  "repos": ["domain.requests.RequestRepository"],
  "timestamp": "2026-01-19T15:43:21.125Z"
}
```
...
```json
{
  ...
  "wired": "drizzle",
  "repos": ["domain.requests.RequestRepository"],
  "timestamp": "2026-01-19T16:22:49.693Z"
}
```
...
_(Note: Different tenant ID - trying to approve request from Tenant A using Tenant B context)_
