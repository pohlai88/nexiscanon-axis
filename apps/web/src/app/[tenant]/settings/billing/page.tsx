...
export default async function BillingPage({ params }: BillingPageProps) {
  ...
  return (
    <div>
      {/* Toast handler for Stripe redirect query params */}
          ...
          >
            ...
            {plan.id === "enterprise" ? (
              <Link
                ...
                className="block w-full py-2 px-4 text-center border border-border rounded-lg hover:bg-muted transition-colors duration-200"
              >
                Contact Sales
              </Link>
            ) : (
