...
export interface Activity {
  id: string;
  type: "comment" | "document" | "user" | "commit" | "task" | "alert" | "metric" | "event";
  user: {
    name: string;
    avatar?: string;
  };
    ...
    >
      ...
      <div className="flex-1 pt-0.5">
        ...
        <p className="text-sm text-foreground mb-2">
          {activity.action}
          {activity.target && (
            <span className="ml-1 font-medium text-primary">{activity.target}</span>
          )}
        </p>
        ...
        {activity.priority && activity.priority !== "low" && (
          <Badge
            ...
            className={cn(
              ...
              activity.priority === "medium" && "border-orange-500 text-orange-600"
            )}
          >
