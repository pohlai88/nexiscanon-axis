...
export interface Template {
  ...
  description?: string;
  category: string;
  type: "invoice" | "purchase_order" | "contract" | "form" | "workflow" | "report" | "email" | "custom";
      ...
      <div className="space-y-4 py-4">
        ...
        <div className="grid grid-cols-2 gap-4 text-sm">
          ...
          <div>
            ...
            <p className="font-medium">{template.isPublic ? "Public" : "Private"}</p>
          </div>
        </div>
        ...
        <div className="rounded-lg border bg-muted/30 p-4">
          <p className="text-sm text-muted-foreground mb-2">Template Data Preview</p>
