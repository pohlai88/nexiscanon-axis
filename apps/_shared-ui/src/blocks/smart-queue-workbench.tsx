...
export function SmartQueueWorkbench({
  ...
  const [activeQueue, setActiveQueue] = React.useState(selectedQueueId || queues[0]?.id);
  const [activeItem, setActiveItem] = React.useState<string | null>(selectedItemId || null);
  ...
  return (
    <div className={cn("flex h-screen flex-col", className)}>
        ...
        <div className="border-b bg-muted/30 px-4 py-3">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-4 text-xs text-muted-foreground">
              <kbd className="rounded border bg-background px-2 py-1">↑↓</kbd>
              <span>Navigate</span>
              <kbd className="rounded border bg-background px-2 py-1">Enter</kbd>
              <span>Approve</span>
            </div>
          </div>
        </div>
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <div className="flex w-96 flex-col border-r bg-muted/20">
          {/* Queue Tabs */}
            ...
            <div className="p-2 space-y-1">
              {filteredItems.length === 0 ? (
                <div className="flex flex-col items-center justify-center py-12 text-center">
                  <CheckCheck className="h-12 w-12 text-green-600 mb-3" />
          ...
          <CardContent>
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">ID: {item.customer.id}</p>
              </div>
            </div>
          </CardContent>
        </Card>
