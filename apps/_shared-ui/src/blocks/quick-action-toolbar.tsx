...
export function QuickActionToolbar({
  ...
  const positionStyles = {
    ...
    bottom: "sticky bottom-0 z-10 border-t bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60",
    floating: "fixed bottom-8 left-1/2 -translate-x-1/2 z-50 rounded-full border shadow-lg bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/90",
  };
