...
export interface TimelineEvent {
  id: string;
  timestamp: string;
  type: "create" | "edit" | "delete" | "approve" | "reject" | "comment" | "attach" | "share" | "status_change" | "assign";
  user: {
    id: string;
    name: string;
    avatar?: string;
...
export function TimelinePlayback({
  ...
  const getEventColor = (type: string, metadata?: TimelineEvent["metadata"]) => {
              ...
              {events.map((event, index) => (
                ...
                >
                  ...
                  {index < events.length - 1 && (
                    <div
                      className={cn(
                        "absolute left-[26px] top-[40px] h-full w-0.5",
              ...
              <ScrollArea className="flex-1">
                <div className="p-6 space-y-6">
                  ...
                  {currentEvent.metadata?.field && (
                    <Card>
                      <CardHeader>
                        <CardTitle className="text-base">Value Change</CardTitle>
                      </CardHeader>
                      <CardContent>
          ...
          {recentEvents.map((event, index) => (
            <div key={event.id} className="flex items-start gap-3">
              ...
              {index < recentEvents.length - 1 && (
                <div className="absolute left-[29px] top-[32px] h-full w-px bg-border" />
              )}
