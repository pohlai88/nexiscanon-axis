      ...
      <div className="flex-1 relative overflow-hidden bg-muted/20">
        <div
          ...
          className={cn(
            ...
            showGrid && "bg-[radial-gradient(circle,_#00000008_1px,_transparent_1px)] bg-[length:20px_20px]"
          )}
          style={{
        ...
        {/* Zoom Controls */}
        <div className="absolute bottom-4 right-4 flex items-center gap-2 bg-background border rounded-lg p-2 shadow-lg">
  ...
  if (element.type === "sticky") {
    return (
      ...
      >
        ...
        {isSelected && (
          <div className="absolute -top-10 left-0 flex items-center gap-1 bg-background border rounded-lg p-1 shadow-lg">
            <Button
              variant="ghost"
              size="sm"
              onClick={(e) => {
            ...
            .map((element) => (
              <Card key={element.id}>
                <CardContent className="p-3">
                  <p className="text-sm font-medium mb-2">{element.content}</p>
