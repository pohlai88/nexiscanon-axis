...
```tsx
import { DataFortress, DataFortressColumn, DataFortressRow } from "@workspace/shared-ui/blocks";
    ...
    },
    {
      ...
      cell: (row) => (
        <div>
          ...
          <div className="text-sm text-muted-foreground">{row.contactEmail}</div>
        </div>
      ),
    },
    {
