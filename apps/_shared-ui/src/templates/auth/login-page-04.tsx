                  ...
                  <FieldGroup>
                    ...
                    <Field>
                      <div className="flex items-center">
                        ...
                        <a
                          href="#"
                          className="ml-auto inline-block text-sm underline-offset-4 transition-colors duration-200 hover:underline text-primary"
                        >
                          Forgot password?
                        </a>
                      </div>
                    ...
                    <Field>
                      ...
                      <p className="text-center text-sm text-muted-foreground">
                        ...
                        <a href="#" className="text-primary transition-colors duration-200 hover:underline">
                          Sign up
                        </a>
                      </p>
                    </Field>
